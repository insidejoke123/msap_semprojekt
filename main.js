let camera = {
    ...
    width: 1959,
    height: 1090,
    position: [0, 0, 0], // Camera position set to the origin
    rotation: [
        [1, 0, 0], // Identity matrix for no rotation
        [0, 1, 0],
        [0, 0, 1]
    ],
...
`.trim();
const ceilingHeight = 10; // Maximum height the camera can reach
const floorHeight = -10; // Minimum height the camera can go

let defaultViewMatrix = [
    0.47, 0.04, 0.88, 0, -0.11, 0.99, 0.02, 0, -0.88, -0.11, 0.47, 0, 0.07,
    0.03, 6.55, 1,
];
let viewMatrix = getViewMatrix(camera); // Using the initial camera setup
async function main() {
    let carousel = false;
